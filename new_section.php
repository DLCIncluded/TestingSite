...
include_once("includes/top.php");
	...
	if(isset($username) && $username!='' && $_SESSION['siteLevel'] >= 5){
		...
		<form action="includes/postHandler.php" method="post" name="newSection">
			...
			<input type="text" name="section_title" size="20" placeholder="Title for section" /><br>
			...
			<input type="hidden" name="post_type" value="c" /><!-- a for new, b for reply -->
		</form>
		
		<?PHP
		}else{
		echo "Either you do not have access to this page, or you need to <a href='#' class='login-button'>Login</a>, only site admins can see this page. ";
	}
